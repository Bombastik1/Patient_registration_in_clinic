...
Developer 1: Денисенко Денис Віталійович — реалізація моделі даних (DAO/Service), SQL-скрипти.
Developer 2: Кубуша Олексій Сергійович — розробка UI (JavaFX/FXML), контролери інтерфейсу.
